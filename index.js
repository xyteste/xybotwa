 ...
 rows: [

                          {
                           ...
                           },
                           {
                              ...
                              "title": "menu en español",
                              "rowId": `${prefix}` + "menuesp"
...
*este bot es de uso gratuito,* puedes conseguirlo a través de mi canal de youtube (esta en portugues de brasil):
https://youtube.com/channel/UCEXnX1CqgbV5xVabZG71aUw
...
random = `${Math.floor(Math.random() * 35)}`
const sexx = random
if (sexx < 13 ) {pp = 'solo fimosis'} else if (sexx == 13 ) {pp = 'pasó el promedio😳'} else if (sexx == 14 ) {pp = 'pasó el promedio😳'} else if (sexx == 15 ) {pp = 'eita, vai pegar manga?'} else if (sexx == 16 ) {pp = 'eita, vai pegar manga?'} else if (sexx == 17 ) {pp = 'calma man, a mina não é um poço😳'} else if (sexx == 18 ) {pp = 'calma man, a mina não é um poço😳'} else if (sexx == 19 ) {pp = 'calma man, a mina não é um poço😳'} else if (sexx == 20 ) {pp = 'você tem um poste no meio das pernas'} else if (sexx == 21 ) {pp = 'você tem um poste no meio das pernas'} else if (sexx == 22 ) {pp = 'você tem um poste no meio das pernas'} else if (sexx == 23 ) {pp = 'você tem um poste no meio das pernas'} else if (sexx == 24 ) {pp = 'você tem um poste no meio das pernas'} else if (sexx > 25 ) {pp = 'vai procurar petróleo com isso?'
}
hasil = `tu pene tiene ${random}cm\n\n${pp}`
reply(hasil)
break
...
try {
      ranp = getRandom('.gif')
      rano = getRandom('.webp')
			anu = await getBuffer(`https://api.lolhuman.xyz/api/random2/classic?apikey=KurrXd`)			
