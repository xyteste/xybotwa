...
reply(`*❱❱ Aguarde...Estou Criando. ❰❰*`)
  buffer = await getBuffer(`https://xyruss.sirv.com/images%20(1).jpeg?text.0.text=${blk}&text.0.position.x=-58%25&text.0.position.y=-18%25&text.0.size=28&text.0.color=000000&text.0.font.style=italic" width="557" height="550" alt="" />`)
